            ...
            <div className="flex flex-col sm:flex-row w-[50vw] min-w-[300px] min-h-[70vh]  m-auto shadow-lg rounded-xl border border-[var(--primary)] sm:min-w-[550px] ">
                ...
                <div className="flex-1 bg-gray-100  rounded-bl-xl rounded-br-xl sm:rounded-bl-none sm:rounded-tr-xl flex flex-col pb-4 h-auto ">
                    ...
                    <form className="flex flex-col w-[90%] m-auto h-80 rounded-xl pt-10 " action="">
                        ...
                        <input type="text" placeholder="email" className="w-[90%] max-w-72 h-9 rounded-xl border border-gray-400 p-2 text-center outline-0 focus:border-[var(--accent)] focus:w-[95%] transition-all m-auto focus-shadow" required></input>
