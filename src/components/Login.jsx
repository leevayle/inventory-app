    ...
    <div className="flex flex-col h-[85%] w-[90%] max-w-100 max-h-200">
      ...
      <div className='w-full h-auto mt-7 title flex flex-col '>
          <div className='h-15 flex ml-auto mr-auto text-5xl'>
              <p><span className='title1 '>Welcome </span><span className='text-[var(--primary)]'>Log </span><span className='title1 text-[var(--accent)] '>In</span></p>
          </div>

          <div className=' w-full h-auto sub'>
          <p className='text-center text-[var(--subtext)] mt-5'>Click on forgot password to reset  <br /> your password</p>
      </div>
      ...
      <div className=' flex flex-1 flex-col'>
          <form className='flex flex-col flex-1'>
              ...
              <div className=' h-35 mt-auto flex flex-col'>
                  ...
                  <a href='/Reset'  className='m-auto text-[var(--subtext)] poppins'><p >Forgot password?</p></a>
